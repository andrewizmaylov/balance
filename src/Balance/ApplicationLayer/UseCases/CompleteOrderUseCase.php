...
readonly class CompleteOrderUseCase
{
    ...
    /**
     * @throws CompleteTransactionException|Throwable
     */
    public function execute(string $transactionId): BalanceTransaction
    {
        ...
        $this->checkTransactionService->checkOrderCanBeCompleted($activeTransaction);
