...
readonly class ReleaseCoinsUseCase
{
    ...
    /**
     * @throws UnconfirmedTransactionException|Throwable
     */
    public function execute(string $transactionId): BalanceTransaction
    {
        ...
        $this->checkTransactionService->checkCoinsCanBeReleased($activeTransaction);
