...
use Src\Balance\PresentationLayer\HTTP\V1\Requests\CompleteOrderRequest;
use Src\Balance\ApplicationLayer\UseCases\CompleteOrderUseCase;
...
final class CompleteOrderController extends Controller
{
    public function __construct(
        ...
        public CompleteOrderUseCase $process,
        public BalanceTransactionResponder $responder,
    ) {}

    public function __invoke(CompleteOrderRequest $request): JsonResponse
    {
        try {
            ...
            $this->logger->critical(
                'An unexpected error occurred with CompleteOrderController' . $exception->getMessage(),
